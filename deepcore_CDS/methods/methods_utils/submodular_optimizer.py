        ...
        for i in range(sum(selected), self.budget):
            ...
            while True:
                ...
                if new_gain >= self.beta * max_gain:
                    ...
                    flag += 1
                    if i>200:
                        print('else: cur_max_element=',cur_max_element)
                        print('self.beta * max_gain={}, max_gain={}, new_gain={}'.format(self.beta * max_gain, max_gain, new_gain))
                    if flag == 200:
                        raise RuntimeError('end test, i={}'.format(i))
        return self.index[selected]
