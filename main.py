...
import argparse
import deepcore_CDS.nets as nets
import deepcore_CDS.datasets as datasets
import deepcore_CDS.methods as methods
...
def main():
    ...
    for exp in range(start_exp, args.num_exp):
        ...
        channel, im_size, num_classes, class_names, mean, std, dst_train, dst_test = datasets.__dict__[args.dataset] \
            (args.data_path) #materialize/create an object
